...
export interface FrontendActionsApi {
	...
	completion_create: (
		...
		Result<{ value: ActionOutputs['completion_create'] }, { error: JsonrpcErrorObject }>
	>;
	completion_progress: (
		input?: ActionInputs['completion_progress'],
		options?: RpcClientCallOptions
	) => Promise<
		Result<{ value: ActionOutputs['completion_progress'] }, { error: JsonrpcErrorObject }>
	>;
	...
	terminal_data_send: (
		...
		Result<{ value: ActionOutputs['terminal_data_send'] }, { error: JsonrpcErrorObject }>
	>;
	terminal_data: (
	...
	workspace_changed: (
		...
		Result<{ value: ActionOutputs['workspace_changed'] }, { error: JsonrpcErrorObject }>
	>;
}
