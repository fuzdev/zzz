...
- AI provider integration (Claude, ChatGPT, Gemini)
...
| `zzz_action_handlers.ts`        | Handler factory `create_zzz_action_handlers(backend)` — single source of truth for all 15 actions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
All 15 request_response handlers are built by
...
create_zzz_app.ts: create_zzz_app({config, password, runtime, get_connection_ip})
    ...
    ├── Add providers (Claude, ChatGPT, Gemini)
...
| Authenticated | `{account: 'required', actor: 'none'}`                                                            | All file, terminal, workspace, completion, provider ops |
