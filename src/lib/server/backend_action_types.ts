...
export interface BackendActionHandlers {
	...
	terminal_create?: {
		...
		) => ActionOutputs['terminal_create'] | Promise<ActionOutputs['terminal_create']>;
		send_response?: (
	...
	terminal_data_send?: {
		...
		) => ActionOutputs['terminal_data_send'] | Promise<ActionOutputs['terminal_data_send']>;
		send_response?: (
	...
	terminal_resize?: {
		...
		) => ActionOutputs['terminal_resize'] | Promise<ActionOutputs['terminal_resize']>;
		send_response?: (
	...
	terminal_close?: {
		...
		) => ActionOutputs['terminal_close'] | Promise<ActionOutputs['terminal_close']>;
		send_response?: (
	...
	workspace_open?: {
		...
		) => ActionOutputs['workspace_open'] | Promise<ActionOutputs['workspace_open']>;
		send_response?: (
	...
	workspace_close?: {
		...
		) => ActionOutputs['workspace_close'] | Promise<ActionOutputs['workspace_close']>;
		send_response?: (
	...
	workspace_list?: {
		...
		) => ActionOutputs['workspace_list'] | Promise<ActionOutputs['workspace_list']>;
		send_response?: (
